export const data = [
	{
		id: 1,
		subject: "CECS 328 - ALGORITHMS",
		description: "Greedy algorithms, dynamic programming, divide and conquer, network flow, approximation algorithms, NP-complete problems. Programming projects to exemplify these concepts.",
	},
	{
		id: 2,
		subject: "CECS 274 - DATA STRUCTURES",
		description: "Topics include lists, hash tables, binary trees, balanced trees, heaps, sorting-algorithms, graphs, external memory searching.",
	},
	{
		id: 3,
		subject: "CECS 323 - DATABASE FUNDAMENTALS",
